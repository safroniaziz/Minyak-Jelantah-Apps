    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                    ...
                    <tbody>
                        ...
                        @foreach ($kurirs as $index => $kurir)
                            <tr>
                                ...
                                <td>{{ $kurir->email }}</td>
                                <td>{{ $kurir->nomor_whatsapp }}</td>
                                <td>{{ $kurir->alamat }}</td>
                                <td class="text-center">
                                    <a onclick="ubahPassword({{ $kurir->id }})" class="btn btn-primary btn-sm btn-flat" style="color:white; cursor:pointer;"><i class="fa fa-key"></i></a>
                                </td>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <a href="{{ route('kurir.edit',[$kurir->id]) }}" class="btn btn-success btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                            </td>
                                            <td>
                                                <form action="{{ route('kurir.delete',[$kurir->id]) }}" method="POST" id="form-hapus">
                ...
                @include('kurir.partials.ubah_password')
            </div>
        </div>
    </div>
</div>

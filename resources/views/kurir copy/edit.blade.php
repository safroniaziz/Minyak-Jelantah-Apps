    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <form action="{{ route('administrator.update',[$administrator->id]) }}" enctype="multipart/form-data" method="POST" class="form">
                    <div class="box-body">
                        <div class="row">
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Nama Lengkap :</label>
                            <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ $administrator->nama_lengkap }}" class="form-control" autocomplete="off">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Email :</label>
                            <input type="email" name="email" id="email" value="{{ $administrator->email }}" id="email" class="form-control" autocomplete="off">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Nomor WhatsApp</label>
                            <input type="number" name="nomor_whatsapp" id="nomor_whatsapp" value="{{ $administrator->nomor_whatsapp }}" id="nomor_whatsapp" class="form-control" autocomplete="off">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Alamat :</label>
                            <input type="text" name="alamat" id="alamat" value="{{ $administrator->alamat }}" class="form-control" autocomplete="off">
                        </div>
                    </div>

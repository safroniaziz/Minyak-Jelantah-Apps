@push('scripts')
    ...
    <script>
        ...
        function editData(id){
            ...
            url = "{{ url('informasi_pengumuman').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
                success : function(data){
                    ...
                    $('#id_edit').val(data.id);
                    $('#judul_konten_edit').val(data.judul_konten);
                    $('#teks_konten_edit').val(data.teks_konten);
                    $('#tujuan_konten_edit').val(data.tujuan_konten);
                },
                error:function(){
                    $('#gagal').show(100);
                }

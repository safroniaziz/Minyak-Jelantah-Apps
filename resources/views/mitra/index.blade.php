    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                    ...
                    <tbody>
                        ...
                        @foreach ($mitras as $index => $mitra)
                            <tr>
                                ...
                                <td>{{ $mitra->email }}</td>
                                <td>{{ $mitra->nomor_whatsapp }}</td>
                                <td>{{ $mitra->alamat }}</td>
                                <td class="text-center">
                                    <a onclick="ubahPassword({{ $mitra->id }})" class="btn btn-primary btn-sm btn-flat" style="color:white; cursor:pointer;"><i class="fa fa-key"></i></a>
                                </td>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <a href="{{ route('mitra.edit',[$mitra->id]) }}" class="btn btn-success btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                            </td>
                                            <td>
                                                <form action="{{ route('mitra.delete',[$mitra->id]) }}" method="POST" id="form-hapus">
                ...
                @include('mitra.partials.ubah_password')
            </div>
        </div>
    </div>
</div>
